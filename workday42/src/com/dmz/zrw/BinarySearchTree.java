...
public class BinarySearchTree<E extends Comparable<? super E>> {
    ...
    //这里传入的list要为中序遍历后得到的list，求 给定一棵二叉搜索树，它的根结点为root。求这棵树中不同结点的最小差值。
    public  int minGap(List<Integer> list){
    ...
    public static void main(String[] args) {
        ...
        System.out.println(tree.minGap(inlist));
